(function() {
	...
	$(".rule-text").on('click', function() {
		Util.message("温馨提示", "<p>1、用户加入预售智能理财后，将在12月18日00:00后匹配标的，按照各理财项目计息规则进行收益结算；</p><p>2、成功加入预售智能理财的金额将计入12月18日~12月19日的个人累计加入智能理财金额。</p><p>3、加入预售理财，同样享有加息特权奖励，12月18日可优先匹配标的。</p>",
			function() { //点击关闭按钮
