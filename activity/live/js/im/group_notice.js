(function(win) {
    ...
    var groupNotice = {
        //监听 申请加群 系统消息
        onApplyJoinGroupRequestNotify: function(notify) {
        ...
        //监听 申请加群被同意 系统消息
        onApplyJoinGroupAcceptNotify: function(notify) {
        ...
        //监听 申请加群被拒绝 系统消息
        onApplyJoinGroupRefuseNotify: function(notify) {
        ...
        //监听 被踢出群 系统消息
        onKickedGroupNotify: function(notify) {
        ...
        //监听 解散群 系统消息
        onDestoryGroupNotify: function(notify) {
        ...
        //监听 创建群 系统消息
        onCreateGroupNotify: function(notify) {
        ...
        //监听 被邀请加群 系统消息
        onInvitedJoinGroupNotify: function (notify) {
        ...
        //监听 主动退群 系统消息
        onQuitGroupNotify: function (notify) {
        ...
        //监听 被设置为管理员 系统消息
        onSetedGroupAdminNotify: function (notify) {
        ...
        //监听 被取消管理员 系统消息
        onCanceledGroupAdminNotify: function(notify) {
        ...
        //监听 群被回收 系统消息
        onRevokeGroupNotify: function (notify) {
        ...
        //监听 用户自定义 群系统消息
        onCustomGroupNotify: function (notify) {
        ...
        //监听 群资料变化 群提示消息
        onGroupInfoChangeNotify: function (groupInfo) {
