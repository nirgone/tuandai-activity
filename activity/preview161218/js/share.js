(function() {
	...
	pageContentEl.on("click", ".check-rule", function() {
		Util.message("规则说明", "<p>1、活动期间内，用户登录PC端或者App端进入活动页面点击领取，即可获得1%爱心加息特权，每个用户仅能领取1次。</p><p>2、 用户邀请好友活动期间内注册且累计投资金额满500元即可获得0.15%加息特权，每个用户活动期间内仅有1次机会。</p><p>本活动规则解释权归团贷网所有， 如有疑问请联系在线客服或拨打400 - 6410 - 888</p>",
			function() { //点击关闭按钮
